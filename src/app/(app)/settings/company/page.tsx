...
export const metadata: Metadata = { title: 'Company details · Settings · Apar Dashboard' };
  ...
  return (
    <>
      <ProfileHeader
        ...
        subtitle="Apar's legal profile, statutory numbers, addresses, and documents — editable, copyable, and shared across invoices & reports."
      ...
      {profile ? (
        ...
        <Card>
          <CardContent className="text-muted-foreground py-10 text-center text-sm">
            ...
            create the Apar company row, then reload.
          </CardContent>
        </Card>
      )}
    </>
